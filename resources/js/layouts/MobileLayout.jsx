			...
			<div className="mx-auto w-full max-w-96 overflow-hidden bg-[#f6f3ee]">
				<div className="relative">
					...
					<div className="relative z-10 flex min-h-screen flex-col">
						<header style={{ paddingTop: 'env(safe-area-inset-top)' }} className="px-0">
							{/* ensure header background extends into the status bar area */}
							<div style={{ background: 'transparent' }}>{header}</div>
						</header>
						...
						<footer style={{ paddingBottom: 'env(safe-area-inset-bottom)' }} className="sticky bottom-0 border-t border-[#ece8e1] bg-[#f2eff8] px-3 py-2">
							{footer}
						</footer>
					</div>
				</div>
