...
export default function Index({ transferStok, bahanBakuOptions, filters, flashMessage }) {
    ...
    const currentRows = (transferStok?.data ?? []);
        ...
        <DashboardLayout title="Transfer Stok">
            ...
            <div className="space-y-6">
                ...
                <section className="rounded-3xl border bg-white p-4 shadow-sm md:p-6">
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {hasData ? (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={9} className="py-12 text-center text-sm text-muted-foreground">Belum ada data transfer stok.</TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
                        </Table>
                    ...
                    <PaginationSelect
                        currentPage={transferStok?.meta?.current_page ?? 1}
                        lastPage={transferStok?.meta?.last_page ?? 1}
                        total={transferStok?.meta?.total ?? 0}
                        onPageChange={goPage}
                    />
                </section>
            </div>
