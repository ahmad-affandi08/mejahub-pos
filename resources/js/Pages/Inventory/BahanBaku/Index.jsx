...
import Form from "@/Pages/Inventory/BahanBaku/Form";
                ...
                <section className="rounded-3xl border bg-white p-6 shadow-sm md:p-8">
                    <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                        <div>
                            ...
                            <h1 className="text-2xl font-semibold text-slate-900 md:text-3xl">Bahan Baku</h1>
                                                    ...
                                                    <Dialog open={editingItem?.id === item.id} onOpenChange={(open) => setEditingItem(open ? item : null)}>
                                                        ...
                                                        <DialogContent className="sm:max-w-xl">
                                                            <DialogHeader>
                                                                ...
                                                                <DialogDescription>Perbarui data bahan baku.</DialogDescription>
                                                            </DialogHeader>
                                                            <Form
                                                                mode="edit"
                                                                endpoint={endpoint}
