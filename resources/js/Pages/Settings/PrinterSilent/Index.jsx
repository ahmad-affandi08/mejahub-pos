...
export default function Index({ printerSilent, filters, flashMessage }) {
    ...
    const currentRows = (printerSilent?.data ?? []);
        ...
        <DashboardLayout title="Printer Silent">
            ...
            <div className="space-y-6">
                ...
                <section className="rounded-3xl border bg-white p-4 shadow-sm md:p-6">
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {hasData ? (
                                    ...
                                    <TableRow>
                                        <TableCell colSpan={8} className="py-12 text-center text-sm text-muted-foreground">Belum ada konfigurasi printer.</TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
                        </Table>
                    ...
                    <PaginationSelect
                        currentPage={printerSilent?.meta?.current_page ?? 1}
                        lastPage={printerSilent?.meta?.last_page ?? 1}
                        total={printerSilent?.meta?.total ?? 0}
                        onPageChange={goPage}
                    />
                </section>
            </div>
