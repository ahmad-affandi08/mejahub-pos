    ...
    return (
        <DashboardLayout title="Tiket Dapur">
            ...
            <section className="rounded-3xl border bg-white p-6 shadow-sm md:p-8">
                ...
                <p className="mt-2 text-sm text-slate-600">Halaman frontend sudah disiapkan. Integrasi antrean tiket dapur akan dilanjutkan pada implementasi kitchen workflow.</p>
            </section>
        </DashboardLayout>
    );
}
